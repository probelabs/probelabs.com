...
- **Safe Execution**: Configurable via `allow_edit` flag with proper permission controls - see [GitHub Actions configuration](/docs/github-actions#code-modification-options)
...
- **Reviewdog Integration**: New `allow_suggestions` flag enables AI-powered code suggestions - see [GitHub Actions Integration](/docs/github-actions#suggested-changes-allow_suggestions-true---recommended)
...
- **GitHub Actions Integration**: Automatic trace collection with artifact uploads - see [GitHub Actions Tracing](/docs/github-actions#opentelemetry-tracing)
...
- **probe-engineer.yml**: Dedicated workflow for engineering-focused AI assistance - see [AI Engineer example](/docs/github-actions#example-2-ai-engineer-code-editing-enabled)
