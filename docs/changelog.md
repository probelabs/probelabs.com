...
- Configurable via `allow_edit` flag in [GitHub Actions workflows](/docs/github-actions#code-modification-options)
- Enables AI assistants to make direct code changes during conversations

#### Enhanced GitHub Actions Integration
- **Allow Suggestions Feature**: New `allow_suggestions` flag for suggest-changes integration - see [GitHub Actions Integration](/docs/github-actions#suggested-changes-allow_suggestions-true---recommended)
- **OpenTelemetry Tracing**: Full tracing support for monitoring AI model interactions - see [GitHub Actions Tracing](/docs/github-actions#opentelemetry-tracing)
...
- **Engineer Workflow**: New probe-engineer.yml for specialized engineering tasks - see [GitHub Actions examples](/docs/github-actions#example-2-ai-engineer-code-editing-enabled)
...
- **GitHub Actions Integration**: Automatic trace collection and artifact upload - see [GitHub Actions Tracing](/docs/github-actions#opentelemetry-tracing)
